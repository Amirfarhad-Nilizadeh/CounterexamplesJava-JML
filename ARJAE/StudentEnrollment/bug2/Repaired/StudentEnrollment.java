public class StudentEnrollment {
	...
	if (maxTuitionBalance >= tuitionBalance && !(0 <= enrollmentCredits && enrollmentCredits <= maxSemesterCredits)) { // if (maxTuitionBalance >= tuitionBalance) { //if (maxTuitionBalance < tuitionBalance) {
